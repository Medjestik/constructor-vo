...
function SPPopup({ isOpen, onClose, nsi, onSave, id, printDate, type, isLoading }) {
  ...
  return (
    ...
    >
      <h3 className="popup__title">{`${type === "edit" ? "Редактирование " : "Добавление "}`}Свода правил</h3>
      ...
      <div className="popup__field">
        <h5 className="popup__input-caption">Номер приказа (если есть)</h5>
        <input 
          className="popup__input"
      ...
      <div className="popup__field">
        <h5 className="popup__input-caption">Дата приказа (если есть)</h5>
        <input  
          className="popup__input"
