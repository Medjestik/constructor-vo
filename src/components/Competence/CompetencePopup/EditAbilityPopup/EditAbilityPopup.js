...
function EditAbilityPopup({ isOpen, onClose, currentAbility, onEdit, isShowRequestError, isLoadingRequest }) {
  ...
  return (
    ...
    formWidth={'medium'}
    formName={'edit-ability-popup'}
    >
      <h2 className='popup__title'>Редактирование умения</h2>
...
export default EditAbilityPopup; 